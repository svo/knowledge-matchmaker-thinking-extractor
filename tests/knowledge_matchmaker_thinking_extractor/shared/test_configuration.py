...
from knowledge_matchmaker_thinking_extractor.shared.configuration import (
    ApplicationSettings,
...
class TestApplicationSettings:
    @patch("knowledge_matchmaker_thinking_extractor.shared.configuration.get_resource_path")
    @patch("knowledge_matchmaker_thinking_extractor.shared.configuration.load_properties_file")
...
class TestApplicationSettingProvider:
    @patch("knowledge_matchmaker_thinking_extractor.shared.configuration.ApplicationSettings")
