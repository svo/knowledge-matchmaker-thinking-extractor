...
from knowledge_matchmaker_thinking_extractor.interface.api.main import main
...
class TestMainConfiguration:
    @patch("knowledge_matchmaker_thinking_extractor.interface.api.main.uvicorn.run")
